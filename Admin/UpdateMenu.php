		...
		else
		{
			...
			while (($Row = mysqli_fetch_row($QueryResult)))
			{
				...
				&nbsp &nbsp &nbsp
					...
					<tr>
						<td>Crabby Crab</td>
						<td><input type='number' name='CrabbyC' min='1' max='1000'></td>
					</tr>

					<tr>
						<td>Chicken Cheese</td>
						<td><input type='number' name='ChickenC' min='1' max='1000'></td>
					</tr>

					<tr>
						<td>Baby Octopus </td>
						<td><input type='number' name='baby' min='1' max='1000'></td>
					</tr>

					<tr>
						<td>Mix </td>
						<td><input type='number' name='mix' min='1' max='1000'></td>
					</tr>
