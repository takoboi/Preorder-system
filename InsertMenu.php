...
<form name='menu' action='insert.php' method='POST' enctype="multipart/form-data">
	<table class="box">
		...
		<tr>
			<td>Crabby Crab Quantity: <input type='number' id='CrabbyC' name='CrabbyC' min="1"max="1000" required></td>
		</tr>

		<tr>
			<td>Chicken Cheese Quantity: <input type='number' id='ChickenC' name='ChickenC' min="1"max="1000" required></td>
		</tr>

		<tr>
			<td>Baby Octopus Quantity: <input type='number' id='BabyO' name='BabyO' min="1"max="1000" required></td>
		</tr>
						
		<tr>
			<td>Mix Quantity: <input type='number' id='mix' name='mix' min="1"max="1000" required></td>
		</tr>
